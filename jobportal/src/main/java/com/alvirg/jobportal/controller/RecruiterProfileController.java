...
import com.alvirg.jobportal.services.RecruiterProfileService;
import com.alvirg.jobportal.util.FileUploadUtil;
...
public class RecruiterProfileController {
    ...
    public String recruiterProfile(Model model){
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            Optional<RecruiterProfile> recruiterProfile = recruiterProfileService.getOneUserProfile(users.getUserId());
    ...
    public String addNew(RecruiterProfile recruiterProfile,
        ...
        // processing the file for the recruiter profile image
        String fileName = "";
